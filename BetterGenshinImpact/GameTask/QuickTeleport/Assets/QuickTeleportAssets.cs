...
public class QuickTeleportAssets : BaseAssets<QuickTeleportAssets>
{
    ...
    private QuickTeleportAssets()
    {
        ...
        // Широкая область распознавания кнопки перевода
        ...
        // кнопка переключения подземного мира
        // Потому что есть контент с похожими цветами，Так что используйте3ряд
    ...
    ///
    /// Ограничьте небольшие территории，Предотвращение ошибочной идентификации
    /// </summary>
