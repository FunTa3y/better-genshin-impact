...
namespace BetterGenshinImpact.ViewModel
{
    public partial class MaskWindowViewModel : ObservableRecipient
    {
        ...
        private void InitializeStatusList()
        {
            if (Config != null)
            {
                StatusList.Add(new StatusItem("\uf256 подобрать", Config.AutoPickConfig));
                StatusList.Add(new StatusItem("\uf075 сюжет", Config.AutoSkipConfig));
                StatusList.Add(new StatusItem("\ue5c8 Приглашать", Config.AutoSkipConfig, "AutoHangoutEventEnabled"));
                StatusList.Add(new StatusItem("\uf578 ловит рыбу", Config.AutoFishingConfig));
                StatusList.Add(new StatusItem("\uf3c5 передавать", Config.QuickTeleportConfig));
            }
        }
        ...
        private void RefreshSettings()
        {
            ...
            if (Config != null)
            {
                ...
                // довольно особенный，Планировщик задач должен быть запущен для получения информации о масштабировании
        ...
        /// <summary>
        /// это окнодовольно особенный，Внедрение зависимостей конструктора не может использоваться напрямую.
        /// </summary>
