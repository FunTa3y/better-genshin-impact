...
/// <summary>
/// Отображение объекта конфигурации сочетания клавиш на странице
/// </summary>
public partial class HotKeySettingModel : ObservableObject
{
    ...
    /// <summary>
    /// Мониторинг клавиатуры и мыши、Глобальные горячие клавиши 
    /// </summary>
    ...
    /// <summary>
    /// Глобальные горячие клавишиКонфигурация
    /// </summary>
    public HotkeyHook? GlobalRegisterHook { get; set; }

    /// <summary>
    /// Конфигурация мониторинга клавиатуры
    /// </summary>
    public KeyboardHook? KeyboardMonitorHook { get; set; }

    /// <summary>
    /// Конфигурация прослушивания мыши
    /// </summary>
    ...
    public void RegisterHotKey()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    // Если это комбинация клавиш，не поддерживается
