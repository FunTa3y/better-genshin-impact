...
internal static class RuntimeHelper
{
    ...
    public static void RestartAsElevated(string fileName = null!, string dir = null!, string args = null!, int? exitCode = null, bool forced = false)
    {
        try
        {
            ...
            {
                Debug.WriteLine(ex);
                MessageBox.Show("Начните с правами администратора BetterGI неудача，Все функции моделирования недоступны с правами администратора.！\r\nПожалуйста попробуйте Щелкните правой кнопкой мыши —— Запустить от имени администратора Начать с BetterGI",
                    "предупреждать", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
        }
