...
public class GraphicsCapture : IGameCapture
{
    ...
    /// <summary>
    /// от DwmGetWindowAttribute прямоугольник перехватывать GetClientRectпрямоугольник（игровая зона）
    /// </summary>
    ...
    private ResourceRegion? GetGameScreenRegion(nint hWnd)
    {
        ...
        //POINT point = default; // Этот момент и DwmGetWindowAttribute Плохие результаты1
