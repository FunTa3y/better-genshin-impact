...
public class CameraOrientationTest
{
    ...
    {
        var mat = Cv2.ImRead(@"E:\HuiTask\Улучшенный Genshin Impact\Автоматическое секретное царство\Определение направления просмотра\3.png", ImreadModes.Grayscale);
        ...
        Cv2.ImShow("После преобразования полярных координат", polarRoiMat);
        //Cv2.ImWrite(@"E:\HuiTask\Улучшенный Genshin Impact\Автоматическое секретное царство\Определение направления просмотра\2_p.png", polarRoiMat);
    ...
    {
        var mat = Cv2.ImRead(@"E:\HuiTask\Улучшенный Genshin Impact\Автоматическое секретное царство\Определение направления просмотра\1.png", ImreadModes.Color);
